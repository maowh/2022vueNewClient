export default {
  ...
  cost: {
    ...
    operationAmountPlan: '季度计划-运维',
    developAmountPlan: '季度计划-研发',
    reportedAmountReality: '季度实绩-总额',
    operationAmountReality: '季度实绩-运维',
    developAmountReality: '季度实绩-研发',
    reportedAmountPercentage: '总额完成百分比',
    operationAmountPercentage: '运维完成百分比',
    developAmountPercentage: '研发完成百分比',
    reportedAmount: '上报金额',
