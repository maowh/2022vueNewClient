export default {
  ...
  route: {
    ...
    projectInfomationList: 'ProjectInfomationList',
    projectInfomationInfo: 'ProjectInfomationInfo',
    projectInfomationEdit: 'projectInfomationEdit',
    projectInfomationCreate: 'projectInfomationCreate',
    projectcosts: 'projectcosts',
    projectcostsInfo: 'projectcostsInfo',
    projectcostsEdit: 'projectcostsEdit',
    projectcostsCreate: 'projectcostsCreate',
    ...
    coststandardCreate: 'coststandardCreate',
    ...
    personnelloadreport: 'personnelloadreport',
    personnelloaddetail: 'personnelloaddetail',
    personnelmatrixreport: 'personnelmatrixreport',
    costsreport: 'costsreport',
    costsfinish: 'costsfinish',
    customerinformation: 'customerinformation',
    domaininformation: 'domaininformation',
    projectcostsreport: 'projectcostsreport',
    manpowerInput: 'manpowerInput',
    manpowerInputInfo: 'manpowerInputInfo',
    manpowerInputEdit: 'manpowerInputEdit',
    manpowerInputCreate: 'manpowerInputCreate',
    outsourcingAmount: 'outsourcingAmount',
    outsourcingAmountInfo: 'outsourcingAmountInfo',
    outsourcingAmountEdit: 'outsourcingAmountEdit',
    outsourcingAmountCreate: 'outsourcingAmountCreate',
    project: 'project'
  },
  toast: {
  ...
  cost: {
    ...
    reportedAmountPlan: 'reportedAmountPlan',
    operationAmountPlan: 'operationAmountPlan',
    developAmountPlan: 'developAmountPlan',
    reportedAmountReality: 'reportedAmountReality',
    operationAmountReality: 'operationAmountReality',
    developAmountReality: 'developAmountReality',
    reportedAmountPercentage: 'reportedAmountPercentage',
    operationAmountPercentage: 'operationAmountPercentage',
    developAmountPercentage: 'developAmountPercentage',
    ...
    NonPurchaseAmount: 'NonPurchaseAmount',
    TotalPurchaseAmount: 'TotalPurchaseAmount',
    capitaIncome: 'capitaIncome',
    category: 'category',
    manpowerInputInfo: 'manpowerInputInfo'
  }
}
