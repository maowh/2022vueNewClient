...
const onRemoveClick = (row) => {
  ElMessageBox.confirm(
    ...
    .then(async () => {
      await costDel({ table: 'outsourcingcosts', id: row.id })
...
const onShowClick = (id) => {
  router.push(`/outsourcing/outsourcingInfo/${id}`)
}
...
const onAddClick = () => {
  // const id = ''
  // console.log(id)
  router.push('/outsourcing/outsourcingCreate')
}
// 编辑记录
const onEditClick = (id) => {
  router.push(`/outsourcing/outsourcingEdit/${id}`)
}
</script>
